...
SH_REPORTS.Style = {
	header = Color(0, 0, 0, 170),
	bg = Color(0, 0, 0, 170),
	inbg = Color(0, 0, 0, 170),
	...
	textentry = Color(0, 0, 0, 170),
	menu = Color(0, 0, 0, 170),

	success = Color(0, 0, 0, 170),
	failure = Color(0, 0, 0, 170),
	rating = Color(0, 0, 0, 170),
}
